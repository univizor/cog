...
object PDFReader {
  ...
  def read(fileName: String, data: DataInputStream, fromPage: Option[Int] = Some(0), toPage: Option[Int] = None): (String, PagesDocument) = {
    ...
    val rawDocument: PagesDocument = PagesDocument(fileName, (0 until numberOfPages).map(page => {
  ...
  def readAsDocument(fileName: String, data: DataInputStream, fromPage: Option[Int] = Some(0), toPage: Option[Int] = None) = {
  ...
  def readAsPagesTextDocument(fileName: String, data: DataInputStream, fromPage: Option[Int] = Some(0), toPage: Option[Int] = None) = {
